          ...
          <Col xs lg="6">
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  The name Tetris is a registered trademark of The Tetris
                  Company, LLC. Our use of the name and the game is for
                  non-profit educational use only. No part of this code or
